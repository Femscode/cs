...
<head>
    ...
    <link href="{{ asset('superasset/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('superasset/assets/css/plugins.css')}}" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="{{ asset('superasset/plugins/apex/apexcharts.css')}}" rel="stylesheet" type="text/css">
    <link href="{{ asset('superasset/assets/css/dashboard/dash_2.css')}}" rel="stylesheet" type="text/css" />
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.html"> <span class="navbar-brand-name">VEENODE</span></a>
            </div>
            ...
            <nav id="topbar">
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu active">
                        <a href="/admindashboard"  class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu single-menu">
                        <a href="/allusers" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <ul class="collapse submenu list-unstyled" id="page" data-parent="#topAccordion">
                            ...
                            <li class="sub-sub-submenu-list">
                                <a href="#user-login" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> Login <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        class="feather feather-chevron-right">
                                        <polyline points="9 18 15 12 9 6"></polyline>
    ...
    <script src="{{ asset('superasset/assets/js/libs/jquery-3.1.1.min.js')}}"></script>
    <script src="{{ asset('superasset/bootstrap/js/popper.min.js')}}"></script>
    <script src="{{ asset('superasset/bootstrap/js/bootstrap.min.js')}}"></script>
    <script src="{{ asset('superasset/plugins/perfect-scrollbar/perfect-scrollbar.min.js')}}"></script>
    <script src="{{ asset('superasset/assets/js/app.js')}}"></script>
    <script>
        $(document).ready(function() {
            App.init();
        });
    </script>
    <script src="{{ asset('superasset/assets/js/custom.js')}}"></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    <script src="{{ asset('superasset/plugins/apex/apexcharts.min.js')}}"></script>
    <script src="{{ asset('superasset/assets/js/dashboard/dash_2.js')}}"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    <script src='{{ asset('cdn/sweetalert.min.js')}}'></script>
    <script src="{{ asset('superasset/plugins/table/datatable/datatables.js')}}"></script>
    <script>
        $(document).ready(function() {
            ...
            $("#createnotification").on('submit',async function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                error: function(data) {
                    console.log(data)
                    swal.close()
                    Swal.fire('Opps!', 'Something went wrong, notification not created', 'error')
                }
            })
        })
        ...
        async function resetAccount(el, id) {
            const willUpdate = await Swal.fire({
                title: "Confirm Notification Delete",
            ...
            if (willUpdate.isDismissed == false) {
                ...
                Swal.fire("Notification will not be deleted  :)");
            }
        }
        ...
        function performDelete(el, id) {
            ...
            try {
                $.get('{{ route("deletenotification") }}?id=' + id,
                    function(data, status) {
                        console.log(status);
                        console.table(data);
                        if (status === "success") {
                            let alert = Swal.fire('success', "Notification successfully deleted!.", 'success');
        ...
        async function resetAccount2(el, id) {
            ...
            if (willUpdate.isDismissed == false) {
                ...
                Swal.fire("Ticket will not be deleted  :)");
            }
        }
        ...
        function performDelete2(el, id) {
            ...
            try {
                $.get('{{ route("deleteticket") }}?id=' + id,
                    function(data, status) {
                        console.log(status);
                        console.table(data);
                        if (status === "success") {
                            let alert = Swal.fire('success', "Ticket successfully deleted!.", 'success');
                            $(el).closest("tr").remove();
                            // window.location.reload()
