      ...
      <div class="container">
        ...
        <div class="row justify-content-between">
          <div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
            <img src="assets/img/about-img.svg" class="img-fluid aos-init aos-animate" alt="" data-aos="zoom-in">
          </div>
          <div class="col-lg-6 pt-5 pt-lg-0">
            ...
            <p data-aos="fade-up" data-aos-delay="100" class="aos-init aos-animate">
              ...
              <br><br>Our major aim is to provide affordable and legit services (Data, Cable subscription, Airtime e.t.c) for our partners at large In assurance to give you the best treat, all our services and transactions are running on an automated system. Without any delay, you can instantly get your payments done. We also provide added services in which you can trade your Gift Cards, Cryptocurrency and get paid instantly.
              POS Aggregator
              <br><br>
              We also provide sales of POS terminals in which you can order for your terminal and get your product delivered to you nationwide within a short period at an affordable price
            </p>
