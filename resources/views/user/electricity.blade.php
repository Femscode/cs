                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Electriciy Bill</h4>
                                </div>
                            </div>
                        </div>
                        <form id='electricity_subscription'>
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <select required id='service_type' class="form-control" placeholder="Phone Number">
                                        <option value=''>--select service type--</option>
                                        <option value='Abuja Electricity'>Abuja Electricity</option>
                                        <option value='Eko Electricity'>Eko Electricity</option>
                                        <option value='Ibadan Electricity'>Ibadan Electricity</option>
                                        <option value='Jos Electricity'>Jos Electricity</option>
                                        <option value='Ikeja Electricity'>Ikeja Electricity</option>
                                        <option value='Kaduna Electricity'>Kaduna Electricity</option>
                                        <option value='Kano Electricity'>Kano Electricity</option>
                                        <option value='Portharcourt Electricity'>Portharcourt Electricity</option>
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input required type="number" min='100' id='meter_no' class="form-control"
                    ...
                    <div class="container height-100 d-flex justify-content-center align-items-center">
                        <div class="position-relative">
                            <div class="card p-2 text-center">
                                ...
                                <div class="mt-4"> <button id='buyelectricity'
...
<script>
    ...
    $.ajaxSetup({
        ...
        $("#electricity_subscription").on('submit',async function(e) {
            ...
            if($("#meter_type").val() !== null && $("#meter_no").val() !== null && $("#service_type").val() !== null ) {
        ...
        $("#buyelectricity").on("click", async function(e) {
            e.preventDefault();
            Swal.fire('Subscribing ,please wait...')
            // var image = $('#image')[0].files;
            var fd = new FormData;
            fd.append('meter_type', $("#meter_type").val());
            fd.append('meter_no', $("#meter_no").val());
