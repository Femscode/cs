                        ...
                        <form id='electricity_subscription'>
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <select required id='package' class="form-control" placeholder="Phone Number">
                                        <option value=''>--select package type--</option>
                                        <option value='WAEC_PIN'>WAEC Result Checker PIN - ₦ 1800</option>
                                        <option value='NECO_PIN'>NECO Result Checker PIN - ₦ 2000</option>
                                        <option value='GCE_PIN'>GCE Result Checker PIN - ₦ 1500</option>
                    ...
                    <div class="container height-100 d-flex justify-content-center align-items-center">
                        <div class="position-relative">
                            <div class="card p-2 text-center">
                                ...
                                <div class="mt-4"> <button id='buypin'
...
<script>
    ...
    $.ajaxSetup({
        ...
        $("#electricity_subscription").on('submit',async function(e) {
            ...
            if($("#package").val() !== null  && $("#exam_type").val() !== null ) {
        ...
        $("#buypin").on("click", async function(e) {
            e.preventDefault();
            Swal.fire('Processing ,please wait...')
            // var image = $('#image')[0].files;
            var fd = new FormData;
            fd.append('package', $("#package").val());
            fd.append('exam_type', $("#exam_type").val());
            ...
            $.ajax({
                ...
                success: function($data) {
                    ...
                    Swal.fire('success', 'Pin Purchase Successful, Pin will be sent to your email as well!', 'success')
                    }
                    // window.location.reload()
