                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p>You can deposit or transfer fund to our account stated above.
                        ...
                        <div class="card-body">
                            <div class="alert alert-success" role="alert">
                                <p><strong> Account No: 1234567</strong></p>
                                <p><strong>Account name: Growth Package</strong></p>
                                <p><strong>Bank Name: Wema Bank</strong></p>

                            </div>
                            {{-- <form action="{{ route('manualfunding') }}" method="post" class="form">@csrf --}}
                            <form id='manual_funding'>
                              
                                <div class="form-group row mb-0" style="margin-bottom: 0;">
                                    <div class="col-md-6">
                                        <label for="pin">Depositor's name</label>
                                        <div class="input-group">
                                            <input type="text" id='name' class="form-control " id="name" name="depositor_name" placeholder="Enter the Depositor name">
                                                                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" id='manualamount' class="form-control" name="amount" placeholder="Enter the Amount">
                                                                                        </div>
                                    </div>
                                </div>
        ...
        $("#buycable").on("click", async function(e) {
            ...
            $.ajax({
                ...
                success: function($data) {
                    ...
                    Swal.fire('success', 'Account Funded successfully!', 'success')
                    }
                    window.location.reload()
