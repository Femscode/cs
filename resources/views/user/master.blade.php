                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            ...
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between align-items-center breaking-news bg-white">
                                    <div class="d-flex flex-row flex-grow-1 flex-fill justify-content-center py-2 text-white px-1 news"><span><strong class='btn btn-primary btn-sm' style='background-color:#EC4D37'>INFO</strong></span></div>
                                    <marquee class="news-scroll" behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();"> 
                                        <a href="">Welcome to VEENODE. WhatsApp Support No...234 906 185 9864</a><span class="dot"></span>
                                        <a href="">Dear Agent, Kindly click submit button when you input your transaction pin. WhatsApp Support No...234 906 185 9864</a><span class="dot"></span>
                                        <a href="">Thanks for choosing VEENODE..........WhatsApp Support No...234 906 185 9864</a><span class="dot"></span>
