...
<script>
    ...
    $.ajaxSetup({
        ...
        $("#submit_ticket").on('submit',async function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function($data) {
                    ...
                    Swal.fire('success', 'Complain submitted, The Admin will get back to you soon!', 'success')
                    // window.location.reload()
